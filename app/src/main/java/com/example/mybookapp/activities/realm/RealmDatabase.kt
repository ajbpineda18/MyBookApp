...
class RealmDatabase {
    ...
    suspend fun addBook(
        ...
        val dupeBookChecker: BookRealm? = realm.query<BookRealm>(
            "author == $0 && name == $1 && dateBookPublished == $2",
            bookAuthor,
            bookName,
            datePublished
        ).first().find()
        ...
        suspend fun unFavBook(book: Books) {
            realm.write {
                ...
                if (bookRealm != null) {
                    ...
                    throw java.lang.IllegalStateException("Book with ID $bookID not found. Cannot update.")
                }
            }
        }
        ...
        suspend fun archiveBook(book: Books) {
            ...
            realm.write {
                if (bookRealm != null) {
                    ...
                    throw java.lang.IllegalStateException("Book with ID $archiveBookID not found. Cannot update.")
                }
            }
